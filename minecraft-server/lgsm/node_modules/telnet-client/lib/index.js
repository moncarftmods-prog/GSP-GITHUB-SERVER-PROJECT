...
class Telnet extends events_1.EventEmitter {
    ...
    decode(chunk) {
        let str = chunk instanceof Buffer ? chunk.toString(this.opts.encoding) : chunk;
        if (this.opts.escapeHandler) {
            str === null || str === void 0 ? void 0 : str.replace(/\x1B((\[.*?[a-z])|.)/i, seq => {
        ...
        if (this.opts.stripControls) {
            str = str === null || str === void 0 ? void 0 : str.replace(/\x1B((\[.*?[a-z])|.)/i, ''); // Escape sequences
            str = str === null || str === void 0 ? void 0 : str.replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g, ''); // All controls except tab, lf, and cr.
        }
        if (this.opts.newlineReplace)
            str = str === null || str === void 0 ? void 0 : str.replace(/\r\r\n|\r\n?/g, this.opts.newlineReplace);
        return str;
    }
}
